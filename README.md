...
A collection of reusable Codex skills, templates, and related assets.
...
将 skills/ 下的某个技能目录复制到 Codex 技能目录（如 ~/.codex/skills/<技能名>/）即可使用。
每个技能目录内都包含 SKILL.md（技能定义）及配套资源。
